...
console.log(personB.name);  // 输出  xl
```
这段代码涉及到了_proto_及prototype的概念，如果有需要了解，请点击[链接](https://github.com/dreamapplehappy/hacking-with-javascript/blob/master/points/understand-prototype-__proto__.md)[相关](https://www.cnblogs.com/DF-fzh/p/5619319.html)
